 ...
 */
// SU edits
let width = 2 // let width = 10
let length = 4 // let height = 20
// let area = width * height
print(width * length) // print(area)
 ...
 */
let area = width * length // This code was not needed.
let roomArea = area / 2
//print(roomArea)
 ...
 */
//print(3)
let integerDivisionResult: Double = 10 // let integerDivisionResult = 10 / 3
print(integerDivisionResult / 3) // print(integerDivisionResult)
/*:
...
let circumference = pi * diameter // let circumference = 2 * pi * radius
print("The diameter of the circle is \(diameter) and the circumference is \(circumference)") // print(diameter)
// print(circumference)
